...
var Toast = (0, _Toast.createComponent)();
...
function (_React$Component) {
  _inherits(PersistentToast, _React$Component);
  ...
  function PersistentToast() {
    ...
    _classCallCheck(this, PersistentToast);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(PersistentToast)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleClick", (0, _once.default)(function () {
