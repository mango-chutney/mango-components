...
function UnmanagedTootlip(props) {
  ...
  return React.createElement(
    ...
    React.createElement(
      PopperComponent,
      _extends({ clickable: clickable, visible: visible }, rest),
      children,
...
var createStyledComponents = function createStyledComponents(styleProps) {
  var PopperComponent = /*#__PURE__*/(0, _styledComponents2.default)(function (_ref2) {
...
var createComponent = exports.createComponent = function createComponent() {
  ...
  return function (props) {
    return React.createElement(ManagedTootlip, _extends({}, defaultStyledComponents, props));
  };
};
