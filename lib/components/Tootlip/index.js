...
function UnmanagedTootlip(props) {
  ...
  return React.createElement(_reactPortal.Portal, null, React.createElement(PopperComponent, _extends({
    clickable: clickable,
    visible: visible
...
var createStyledComponents = function createStyledComponents(styleProps) {
  var PopperComponent =
  /*#__PURE__*/
  (0, _styledComponents.default)(function (_ref2) {
  ...
  var ArrowComponent =
  /*#__PURE__*/
  (0, _styledComponents.default)(function (_ref3) {
