...
function (_Manager) {
  ...
  function ParentNodeManager() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = ParentNodeManager.__proto__ || Object.getPrototypeOf(ParentNodeManager)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "anchorChild", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: null
    }), Object.defineProperty(_assertThisInitialized(_this), "_setTargetNode", {
      configurable: true,
      enumerable: true,
      writable: true,
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "_getTargetNode", {
      configurable: true,
      enumerable: true,
      writable: true,
