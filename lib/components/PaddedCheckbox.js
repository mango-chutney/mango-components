...
var createStyledComponents = exports.createStyledComponents = function createStyledComponents(styleProps) {
  ...
  var StyledLabelComponent = (0, _styledComponents2.default)(baseComponents.LabelComponent).withConfig({
    componentId: 'd3a23n-0'
  ...
  var StyledInputComponent = (0, _styledComponents2.default)(baseComponents.InputComponent).withConfig({
    componentId: 'd3a23n-1'
