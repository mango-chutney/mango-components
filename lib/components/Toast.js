...
var ToasterFrame = _styledComponents2.default.div.withConfig({
  componentId: 's1bobcl7-0'
...
var CloseButton = _styledComponents2.default.span.withConfig({
  componentId: 's1bobcl7-1'
...
var createStyledComponents = exports.createStyledComponents = function createStyledComponents(styleProps) {
  var ToastComponent = _styledComponents2.default.a.withConfig({
    componentId: 's1bobcl7-2'
...
var createComponent = exports.createComponent = function createComponent() {
  ...
  return function (props) {
    return React.createElement(Toast, _extends({}, props, defaultStyledComponents));
  };
};
