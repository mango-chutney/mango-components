...
var createStyledComponents = exports.createStyledComponents = function createStyledComponents(styleProps) {
  var TristiconComponent = _styledComponents2.default.i.withConfig({
    componentId: 's13os1tu-0'
  })(['&::before{content:"', '";display:inline-block;font:normal normal normal ', ' tristicons;font-size:inherit;text-rendering:auto;vertical-align:inherit;}'], function (props) {
...
var createComponent = exports.createComponent = function createComponent() {
  ...
  return function (props) {
    return React.createElement(Tristicon, _extends({}, props, defaultStyledComponents));
  };
};
