...
var StyledButton = exports.StyledButton = _styledComponents2.default.button.withConfig({
  componentId: 's1cksh9s-0'
})(['background-color:#f0f3f8;border-radius:0.25rem;border:0;color:', ';cursor:pointer;display:', ';font-family:inherit;font-weight:', ';margin-bottom:1rem;padding:0.5rem 1.25rem;text-align:center;text-decoration:none;'], _constants.palette.darkGray, function (props) {
