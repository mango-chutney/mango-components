...
var createStyledComponents = exports.createStyledComponents = function createStyledComponents(styleProps) {
  var ButtonComponent = _styledComponents2.default.button.withConfig({
    componentId: 's1k0rbba-0'
  })(['background-color:#f0f3f8;border-radius:0.25rem;border:0;color:', ';cursor:pointer;display:', ';font-family:inherit;font-weight:', ';margin-bottom:1rem;padding:0.65rem 1.25rem;text-align:center;text-decoration:none;'], styleProps.color, function (props) {
...
var createComponent = exports.createComponent = function createComponent() {
  ...
  return function (props) {
    return React.createElement(Button, _extends({}, props, defaultStyledComponents));
  };
};
